...
actor_prompt_template = ChatPromptTemplate.from_messages(
    [
        (
            ...
            Current time : {time}
            1. {first_instruction}
            2. Reflect and critiwue your answer. Be severe to maximize improvement.
...
# writing the chain for the responsder 
...
print(response) # dude i got response and i saved it in my whatsapp for now can refere from there 